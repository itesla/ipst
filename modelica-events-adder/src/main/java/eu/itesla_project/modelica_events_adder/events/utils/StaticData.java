...
public final class StaticData {
    ...
    public static final String        IPSL        = "iPSL";
    ...
    public static final String        VOLTAGE                = "V_0";
    public static final String        ANGLE                = "angle_0";
    ...
    public static final String         BREAKER_S_PIN        = "s";
    public static final String         BREAKER_R_PIN        = "r";
