...
mvn org.apache.maven.plugins:maven-dependency-plugin:2.8:copy -Dartifact=eu.itesla_project:dymola-proxyservice:0.4.0-SNAPSHOT -DoutputDirectory=$installDir/share/java
