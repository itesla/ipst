...
mvn org.apache.maven.plugins:maven-dependency-plugin:2.8:copy -Dartifact=eu.itesla_project:dymola-proxyservice:0.3.0 -DoutputDirectory=$installDir/share/java
