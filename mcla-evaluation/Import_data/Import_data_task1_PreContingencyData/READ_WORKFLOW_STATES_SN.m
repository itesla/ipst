...
%         limit_ID_idx = find(strcmp(header_ID, extractBefore(header_branches{i},'__TO__')));
        ...
        elseif strcmp(header_branches{i}(end-1:end),'_P')
            ...
            limits_header_branches{i} = num2str(sqrt(3)*str2double(limits_ID{limit_ID_idx})*str2double(voltage_level{i})/1000);
...
%     data_vars=zeros(nbValues,nbVariables);
    ...
    data_vars = [voltage_level; limits_header_branches; data_vars];
