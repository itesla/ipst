...
base_case_path = 'C:\Users\jlmm\INESC\3. Projects\iPST\Server\caserepo\IIDM\SN\2018\03'; % Path for the base cases
CE_path = 'D:\INESC\iPST\Server\FEA 2018jan_feb_nS_50_UniMod'; % Path for CE and output files
out_path = 'D:\INESC\iPST\Server\FEA 2018jan_feb_nS_50_UniMod\Task3\2018_Mar_2sides'; % Path for output files

flow = 2; % Specify 1 for keep variables just in one side of the transmition line.
...
%          continue;
    ...
    state_id_SN = { '-2'; '-1'}; % -2 for the limits and -1 for the SN state
