...
public class OnlineApplicationResource {
    ...
    public WorkflowStatusEnum getStatus(@PathParam("workflowId") String workflowId) {
        WorkflowStatusEnum res = WorkflowStatusEnum.UNDEFINED;
        try {
    ...
    public String getStatesWithSecurityRulesSyntesis(@PathParam("workflowId") String workflowId) {
        ...
        try {
            ...
            if (sria != null) {
                StatesWithSecurityRulesResultSynthesisMessage msg = new StatesWithSecurityRulesResultSynthesisMessage(
                        sria);
                res = msg.toJson();
            }
        } catch (Exception ex) {
