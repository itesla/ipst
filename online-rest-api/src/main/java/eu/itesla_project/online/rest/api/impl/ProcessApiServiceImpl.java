...
import eu.itesla_project.online.rest.api.NotFoundException;
...
public class ProcessApiServiceImpl extends ProcessApiService {
	...
	public ProcessApiServiceImpl() {
      ...
      @Override
      public Response processGet(String user,String basecase,String name,Date date,Date creationDate,SecurityContext securityContext)
