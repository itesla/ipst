...
###                   zero_floor = values which absolute value is under zero_floor are set to zero
###   Outputs       : data_P  = dataframe of forecasts and snapshot measures for all equipments
###   Version       : 3.4
###   Date          : 16/04/2015
##############################################################################################
###   Example:
###   data_P=preprocess_error_box_data(gen_path = "Data/forecastsDiffGen2013.csv",load_path = "Data/forecastsDiffLoads2013.csv",zero_floor)
##############################################################################################


preprocess_data<-function(data_P,zero_floor){
