...
%
function [Y inj_ID idx_err1 idx_fore1 idx_err idx_fore ] = new_method_imputation4(err_new,inj_ID,outliers,Koutliers,tolvar,Nmin_obs_fract,par_nnz,Nmin_obs_interv,check_mod0,idx_err0,idx_fore0,cs)
