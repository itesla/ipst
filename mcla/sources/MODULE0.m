...
%
function [Y inj_ID idx_err idx_fore snapQ  inj_IDQ1 idx_errA idx_foreA YFPF inj_IDFPF tipovar] = MODULE0(snap_filt,fore_filt,inj_IDx,flagPQ,methods,tolvar,Nmin_obs_fr,par_nnz,Nmin_obs_interv,outliers,Koutliers,imputation_meth,Ngaussians,check_mod0,conditional_sampling,tipovar)
