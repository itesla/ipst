...
ofileGUI = 'fea_data_uncertainty_GUI_T1'; %% output mat file which stores the data for the GUI representation of forecast errors
...
m2_ofile='fea_output_m2_T1.mat';  %% module2 output file name
m2_current_folder='.';
...
% module 3 output
m3_ofile='uncond_sampling_output_EU.mat';%'uncond_sampling_output_old.mat';  %'mcsamplerinput_forecast_offline_samples_DACF',%'uncond_sampling_output.mat';  %% module3 output file name
m3_current_folder='.';
