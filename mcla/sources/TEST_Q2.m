...
Ks='19'; %% number of clusters for PCA --> rule of thumb: sqrt(Nsamples/2)
...
FEA_MODULE1_HELPER(m1_ifile, m1_ofile,nations,ofile_forFPF,ofileGUI,IRs, Ks, s_flagPQ,s_method,tolvar,Nmin_obs_fract,Nmin_nz_fract,Nmin_obs_interv,outliers,koutlier,imputation_meth,Ngaussians,percentile_historical,check_module0,tolerance,iterations,epsilo,conditional_sampling,histo_estremeQ,thresGUI,unimodal_separate,modo_invs,isdeterministic,isuniform,opt_GUI);
...
m2_ofile='fea_output_m2.mat';  %% module2 output file name
m2_current_folder='.';
