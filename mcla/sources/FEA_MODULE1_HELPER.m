...
%     clear snap_filt
    ...
    if ~isempty(nations_normal.forec_filt)
        ...
        [dati_FPF] = calcolo_inv_mat_perFPF(snap_filt-forec_filt,forec_filt,inj_ID,flagPQ,method,ofile_forFPF,ofileGUI,par_tolvar,par_Nmin_obs_fract,par_nnz,par_Nmin_obs_interv,par_outliers,Koutliers,par_imputation_meth,par_Ngaussians,check_mod0,percentil,tolerance,iterations,epsilo,thresGUI,modo_inv,tipovar,opt_GUI);
        ...
        if conditional_sampling == 1
              ...
              [Y inj_ID idx_err idx_fore snapQ inj_IDQ dummy1 dummy2 dummy3 dummy4 tipovar] = MODULE0(snap_filt,forec_filt,inj_ID,flagPQ,method,par_tolvar,par_Nmin_obs_fract,par_nnz,par_Nmin_obs_interv,par_outliers,Koutliers,par_imputation_meth,par_Ngaussians,check_mod0,conditional_sampling,tipovar);
       ...
       idx_err0_uni = find(ismember(find(tipovar==1),idx_err0));
        ...
        tic
        [m_y std_y Y_uni inj_ID_uni tipovar_uni idx_err_uni idx_fore_uni matrice idx_fore0_uni tipovar0_uni] = FILTERFOREC(m_y, std_y, Y_uni, inj_ID_uni, tipovar_uni, idx_err_uni, idx_fore_uni);
