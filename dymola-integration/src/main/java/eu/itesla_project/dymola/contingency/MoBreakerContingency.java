 ...
 */
public class MoBreakerContingency extends MoContingency {

    public MoBreakerContingency(String id, String eventDetails, Map<String, String> eventParameters) {
        super(id, eventDetails, eventParameters);
    }

    @Override
    public MoContingencyElementType getMoType() {
        return MoContingencyElementType.MO_BREAKER;
    }
