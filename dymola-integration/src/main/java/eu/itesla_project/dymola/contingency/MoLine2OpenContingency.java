 ...
 */
public class MoLine2OpenContingency extends MoContingency {

    public MoLine2OpenContingency(String id, String eventDetails, Map<String, String> eventParameters) {
